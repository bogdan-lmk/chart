...
var PrimitiveRendererWrapper = class {
  ...
  _internal_drawBackground(target, isHovered, hitTestData) {
    var _a, _b;
    (_b = (_a = this._private__baseRenderer).drawBackground) == null ? void 0 : _b.call(_a, target);
  }
};
...
function findBestPrimitiveHitTest(sources, x, y) {
  ...
  for (const source of sources) {
    ...
    for (const hitResult of primitiveHitResults) {
      if (comparePrimitiveZOrder(hitResult.zOrder, bestPrimitiveHit == null ? void 0 : bestPrimitiveHit.zOrder)) {
